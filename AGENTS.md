...
> 現在地: T15マージ済み。T01〜T18のMVP実装タスクは完了。公開repositoryは `https://github.com/KuwadaKouhei/Tango`。残る未決は OQ-012（本番規模・SLO）。OQ-011は将来。2026-08-26に人間が preview smoke 成功を報告。POC-05 live品質は人手（`docs/RELEASE_GATE.md` 5節）。
...
- preview: 2026-08-26に人間が smoke 成功を報告。POC-05 liveは人手（`docs/RELEASE_GATE.md` 5節）。
