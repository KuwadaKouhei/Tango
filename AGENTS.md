...
> 現在地: T09（ランダム出題）マージ済み。次はT10（exact/normalized判定）。ブランチ予定は `feature/T10-local-judgement`。公開repositoryは `https://github.com/KuwadaKouhei/Tango`。
...
- T01〜T09, T16, T17, T18: マージ済み。次はT10。
