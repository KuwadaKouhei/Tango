...
> 現在地: T15マージ済み。T01〜T18のMVP実装タスクは完了。公開repositoryは `https://github.com/KuwadaKouhei/Tango`。POC-05 liveは条件付き合格。OQ-012は決定済み。`docs/REQUIREMENTS.md` は人間レビュー済み。OQ-011は将来。
...
- 残未決は OQ-011（Chrome拡張）。OQ-012は2026-08-25決定（同時1〜5、単語100、履歴50、アプリ内p95目安約2秒。翻訳・AI判定は timeout 8秒）。`docs/REQUIREMENTS.md` は2026-08-25に人間レビュー済み。T12の model ID は `@cf/meta/llama-3.1-8b-instruct-fast`。
