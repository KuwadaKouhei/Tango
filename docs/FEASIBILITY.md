...
- MVPの想定規模は OQ-012（同時1〜5人、1ユーザー100語、履歴50件）。p95 応答目標は未決。
...
困難判定はないため要件全体の差し戻しは不要。残未決は OQ-011（Chrome拡張）と OQ-012 の p95。POC-05 の `issue-synonym` 外れは 2026-08-25 にMVP許容としたため、model/promptの差し戻しはしない。
